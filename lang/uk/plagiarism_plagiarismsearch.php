...
$string['sources_doc_storage'] = 'Документ vs Сховище';
...
$string['server_connection_error'] = 'Проблема з підключенням до сервера PlagiarismSearch.com';
$string['submit_ok'] = 'Документ \'{$a}\' подано до PlagiarismSearch.com';
$string['submit_error'] = 'Документ \'{$a}\' не подано';
$string['submit_onlinetext_ok'] = 'Онлайн-текст подано до PlagiarismSearch.com';
...
Дізнайтеся, як зареєструватися <a href="https://plagiarismsearch.com/ua/university-plagiarism-checker">тут</a> і попросіть нас про безкоштовну пробну версію <a href="mailto:support@plagiarismsearch.com">support@plagiarismsearch.com</a><br/><br/>';

$string['plagiarismsearch:viewlinks'] = 'Можливість переглядати посилання на результати плагіату';
$string['plagiarismsearch:reviewlinks'] = 'Можливість коментувати та переглядати джерела звіту';
$string['plagiarismsearch:submitlinks'] = 'Можливість надсилати посилання до PlagiarismSearch.com';
